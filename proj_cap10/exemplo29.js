"use strict";
function funcaoPromessa(status) {
...
function executaPromessa() {
    ...
    funcaoPromessa(1) // 1 = sucesso, 2 = erro
        .then((strMensagem) => { console.log("Retorno em caso de sucesso: " + strMensagem); })
        .catch((strMensagem) => { console.log("Retorno em caso de erro: " + strMensagem); });
}
